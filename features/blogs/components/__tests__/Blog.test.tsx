...
import { ILinkNavigation, IShareCard, ITags } from '@/features/shard/types/common';
import { IBlog, ILatestBlogs, IRelatedBlogs } from '@/features/blogs/types/blog';
...
jest.mock('@/features/shard/components/ui/Tags', () => {
...
jest.mock('@/features/blogs/components/ui/LatestBlogs', () => {
...
jest.mock('@/features/blogs/components/ui/RelatedBlogs', () => {
