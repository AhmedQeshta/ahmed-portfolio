      ...
      <section id="contact" className="relative py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-7 lg:px-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
            {/* Contact Information */}
            <div className="order-2 lg:order-1 min-h-[940px]">
              <ScrollAnimation direction="left" delay={0.4}>
                <div className="bg-section-glass min-h-[940px] backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8 lg:p-10 h-full">
            ...
            {/* Contact Form */}
            <div className="order-1 lg:order-2 min-h-[940px]">
