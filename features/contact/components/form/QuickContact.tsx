    ...
    <div className="mt-5">
      ...
      <ScrollAnimation direction="up" delay={0.7}>
        <div className={`pt-4 border-t ${isDark ? 'border-white/10' : 'border-black/10'}`}>
          <p className="text-center text-xs xl:text-sm text-text-secondary">
      ...
      <ScrollAnimation direction="up" delay={0.6}>
        <div className={`mt-5 pt-5 border-t ${isDark ? 'border-white/10' : 'border-black/10'}`}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              <span className="text-sm font-medium text-green-500">Call</span>
            </a>
          </div>
        </div>
      </ScrollAnimation>
